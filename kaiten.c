!<nick> <command> (You send this message to the channel that is defined later in this code.)
<nick> is the nickname of the client and the command is the command that should be sent.  For example, if you
want to tell all the clients with the nickname starting with N, to send you the help message, you type in the channel:                                  *
!N* This will send you a list of all the commands.
...
#define FAKENAME "VEX"	// What you want this to hide as
